...
$sql='( SELECT SQL_CALC_FOUND_ROWS 
	...
	WHERE 
	g_type="branch" AND p.n_id='.$id.' AND p.p_from="grp" 
	...
	( SELECT 
	g.g_id,g.g_name,g.g_pic,g.g_desc,g.g_type,
	NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,count(ci.id) as members  
	FROM 
	grp g LEFT JOIN clg_info ci ON g.g_id=ci.b_id 
	WHERE g.g_id='.$id.' 
	GROUP BY ci.b_id)';
...
if(empty($row['g_id']) OR $row['g_type']!="branch"){
